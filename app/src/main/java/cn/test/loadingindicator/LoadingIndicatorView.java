...
public class LoadingIndicatorView extends View {
    ...
    private static final DotIndicator DEFAULT_INDICATOR=new DotIndicator();
    ...
    public LoadingIndicatorView(Context context) {
        super(context);
        init(context, null,0,R.style.LoadingIndicatorView);
    }
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor=a.getColor(R.styleable.LoadingIndicatorView_indicatorColor, Color.parseColor("#909090"));
